# Ebay\Sell\FulfillmentPolicyApi
...
```php
createFulfillmentPolicy($body): \Ebay\Sell\Account\Model\SetFulfillmentPolicyResponse
```
...
```php
updateFulfillmentPolicy($fulfillment_policy_id, $body): \Ebay\Sell\Account\Model\SetFulfillmentPolicyResponse
```

...
class PaymentsProgramOnboardingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets steps
     *
     * @return \Ebay\Sell\Account\Model\PaymentsProgramOnboardingSteps[]|null
     */
     ...
     * Sets steps
     *
     * @param \Ebay\Sell\Account\Model\PaymentsProgramOnboardingSteps[]|null $steps An array of the active process steps for payment onboarding and the status of each step. This array includes the step name, step status, and a webUrl to the IN_PROGRESS step. The step names are returned in sequential order.
     *
     * @return self
     */

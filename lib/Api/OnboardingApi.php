...
class OnboardingApi
{
    ...
    public function getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse', []),
